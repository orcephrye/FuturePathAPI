...
# Version: 0.1
# Date: 09/08/2026
# Description: Reference data tables for d20 FuturePath character sheets and progression

import logging

from FuturePathAPI.libs.ReferenceData import init_reference_tables

log = logging.getLogger("CharacterReferenceData")
...
def init_character_reference_tables(db_conn=None, force_reload: bool = False):
    """
    Initializes character reference tables in the database if they do not exist.
    """
    tables_data = {
    ...
    return init_reference_tables(tables_data=tables_data, db_conn=db_conn, force_reload=force_reload)
