...
skills, investigative mechanics, and the resolution of a political
conspiracy in the d20 FuturePath setting.

### Adventure Premise {#adventure_premise}

Your station is under threat! The Aconians have raised a small navy to
come to your small sector of space and enforce martial law. Why? They
claim that a person of the old dynasty\'s royal bloodline has gone
missing and was reported to be last seen entering your station. They
blame your people for this!

You are just a small independent mining colony. A station called
**Comet\'s Home** can barely hold 10,000 citizens, and its main source
of income comes from gas mining comets or \'hard\' mining asteroids.
Most of the system\'s population, over 30k if you exclude the station,
live in the inner or outer belt and come to the station to refine and
sell, as well as a little R&R, of course!

You have no idea what an imperial royal from a great and ancient empire
would even be doing here! Your government\'s response is to just keel
over. But you know this isn\'t gonna end good for you and yours unless
by the time that fleet arrives a missing royal can be produced. Time to
take matters into your own hands!

### Key Characters {#key_characters}

1.  **Lady Kaelen:** A headstrong Aconian royal who has openly protested
    her upcoming arranged political marriage.
2.  **Prince Jarek:** Her intended fiancé---a rigid, traditional Aconian
    noble whom Kaelen openly dislikes.
3.  **Valen:** Kaelen\'s true love, a merchant\'s son of lower status.
    Devoted but easily manipulated.
4.  **Archon Vandar:** The orchestrator of the crisis. He secretly
    contacted Valen under the guise of a sympathetic ally, giving him
    this idea and providing him with resources to smuggle Kaelen to this
    independent mining station.

### The Plot {#the_plot}

With Kaelen safely \"missing,\" Vandar frames the disappearance as a
hostile kidnapping by station-dwellers, giving him the perfect excuse to
annex the sector\'s gas and ore infrastructure. Only Vandar knows the
true cause, and he uses it to justify launching a fleet to annex the
Station. Meanwhile, on the Station, Valen and Kaelen immediately find
themselves in hot water. And quickly figure out that they have been
double-crossed. They try to hide and find a safe way to exit the station
but are eventually ambushed by Vandar\'s private hitmen. Vandar\'s goal
is to kill Valen and \'rescue\' Kaelen. He gets to be the hero who saves
the day and the right to annex the system.
...
`   `\
`   Den --> Slums;`\
`   Den --> Refinery[Refinery Control Room];`\
`   Den -.-> Hangar["Hangar B (Red Herring)"];`\
`   `\
`   Clinic --> Slums;`\
`   Clinic --> Refinery;`\
`   `\
...
`   style Consulate fill:#f77,stroke:#333,stroke-width:2px;`\
`   style Hangar fill:#f77,stroke:#333,stroke-width:2px;`
...
`   Depot["The Drifter's Depot"]`\
`   Munitions["Void-Forge Munitions"]`\
`   Noodles["Heng's Cometary Noodles"]`\
`   Dome["The Oasis Bio-Dome"]`

`   style Depot fill:#9cf,stroke:#333,stroke-width:1px;`\
`   style Munitions fill:#9cf,stroke:#333,stroke-width:1px;`\
`   style Noodles fill:#9cf,stroke:#333,stroke-width:1px;`\
`   style Dome fill:#9cf,stroke:#333,stroke-width:1px;`
